...
func InitialSettings() []model.SettingItem {
	...
	initialSettingItems := []model.SettingItem{
		...
		// style settings
		{Key: conf.Logo, Value: "https://res.oplist.org/logo/logo.svg", Type: conf.TypeText, Group: model.STYLE},
		{Key: conf.Favicon, Value: "https://res.oplist.org/logo/logo.svg", Type: conf.TypeString, Group: model.STYLE},
	...
	"epub": {
		...
		//}`, Type: conf.TypeText, Group: model.PREVIEW},
		{Key: "audio_cover", Value: "https://res.oplist.org/logo/logo.svg", Type: conf.TypeString, Group: model.PREVIEW},
